            ...
            <div className="panel mb-5">
                <div className="mb-4 flex items-center sm:flex-row flex-col sm:justify-between justify-center">
                    <div className="sm:mb-0 mb-4">
                        <div className="text-lg font-semibold ltr:sm:text-left rtl:sm:text-right text-center">Takvim</div>
                                ...
                                <Dialog.Panel className="panel border-0 p-0 rounded-lg overflow-hidden w-full max-w-lg text-black dark:text-white-dark">
                                    ...
                                    <div className="p-5">
                                        <form className="space-y-5">
                                            ...
                                            <div>
                                                <label htmlFor="dateStart">Başlangıç :</label>
                                                <input
                                                    id="start"
                                                    type="datetime-local"
                                                    name="start"
                                            ...
                                            <div>
                                                <label htmlFor="dateEnd">Bitiş :</label>
                                                <input
                                                    id="end"
                                                    type="datetime-local"
                                                    name="end"
                                            ...
                                            <div>
                                                ...
                                                <div className="mt-3">
                                                    <label className="inline-flex cursor-pointer ltr:mr-3 rtl:ml-3">
                                                        ...
                                                        />
                                                        <span className="ltr:pl-2 rtl:pr-2">İş</span>
                                                    </label>
                                                    <label className="inline-flex cursor-pointer ltr:mr-3 rtl:ml-3">
                                                        <input
                                                            type="radio"
                                                            ...
                                                            onChange={(e) => setParams({ ...params, type: e.target.value })}
                                                        />
                                                        <span className="ltr:pl-2 rtl:pr-2">Seyahat</span>
                                                    </label>
                                                    <label className="inline-flex cursor-pointer ltr:mr-3 rtl:ml-3">
                                                        <input
                                                            type="radio"
                                                            ...
                                                            onChange={(e) => setParams({ ...params, type: e.target.value })}
                                                        />
                                                        <span className="ltr:pl-2 rtl:pr-2">Kişisel</span>
                                                    </label>
                                                    <label className="inline-flex cursor-pointer">
                                                        <input
                                                            ...
                                                            onChange={(e) => setParams({ ...params, type: e.target.value })}
                                                        />
                                                        <span className="ltr:pl-2 rtl:pr-2">Önemli</span>
                                                    </label>
                                                </div>
                                            </div>
