                ...
                {tabs === 'home' ? (
                    <div>
                            ...
                            <div className="flex flex-col sm:flex-row">
                                ...
                                <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 gap-5">
                                    <div>
                                        ...
                                        <input id="name" type="text" placeholder="Ahmet Yılmaz" className="form-input" />
                                    </div>
                                    <div>
                                        <label htmlFor="profession">Alan</label>
                                        <input id="profession" type="text" placeholder="Web Developer" className="form-input" />
                                    </div>
                                    <div>
                                        <label htmlFor="address">Adres</label>
                                        <input id="address" type="text" placeholder="İstanbul" className="form-input" />
                                    </div>
                                    <div>
                                        <label htmlFor="location">Ülek</label>
                                        <input id="location" type="text" placeholder="Ülke" className="form-input" />
                                    </div>
                                    <div>
                                        <label htmlFor="phone">Telefon</label>
                                        <input id="phone" type="text" placeholder="+9 (530) 555-12121" className="form-input" />
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                        ...
                                        <input id="web" type="text" placeholder="URL" className="form-input" />
                                    </div>
                                    <div>
                                        <label className="inline-flex cursor-pointer">
                                            <input type="checkbox" className="form-checkbox" />
                                            <span className="text-white-dark relative checked:bg-none">Bunu kayıtlı adres yap</span>
                                        </label>
                                    </div>
                        ...
                        <form className="border border-[#ebedf2] dark:border-[#191e3a] rounded-md p-4 bg-white dark:bg-black">
                            <h6 className="text-lg font-bold mb-5">Sosyal</h6>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 mb-5">
                            <div className="panel">
                                <div className="mb-5">
                                    ...
                                    <p>
                                        Changes to your <span className="text-primary">Fatura</span> information will take effect starting with scheduled payment and will be refelected on your next
                                        invoice.
                                    </p>
                                </div>
                                <div className="mb-5">
                                    <div className="border-b border-[#ebedf2] dark:border-[#1b2e4b]">
                                        <div className="flex items-start justify-between py-3">
                                            <h6 className="text-[#515365] font-bold dark:text-white-dark text-[15px]">
                                                Adres #1
                                                <span className="block text-white-dark dark:text-white-light font-normal text-xs mt-1">2249 Esra Sok, Nilüfer, Bursa</span>
                                            </h6>
                                    ...
                                    <div className="border-b border-[#ebedf2] dark:border-[#1b2e4b]">
                                        <div className="flex items-start justify-between py-3">
                                            <h6 className="text-[#515365] font-bold dark:text-white-dark text-[15px]">
                                                Adres #2
                                                <span className="block text-white-dark dark:text-white-light font-normal text-xs mt-1">4262 Yılmaz Sok, Springfield, Massachusetts</span>
                                            </h6>
                                            <div className="flex items-start justify-between ltr:ml-auto rtl:mr-auto">
                                                <button className="btn btn-dark">Düzenle</button>
                                            </div>
