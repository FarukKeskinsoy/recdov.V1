                    ...
                    <div className="relative flex w-full flex-col items-center justify-center gap-6 px-4 pb-16 pt-6 sm:px-6 lg:max-w-[667px]">
                        <div className="w-full max-w-[440px] lg:mt-16">
                            <div className="mb-10">
                                ...
                                <p className="text-base font-bold leading-normal text-white-dark">Kayıt olmak için e-posta ve şifrenizi girin</p>
                            </div>
                            <form className="space-y-5 dark:text-white" onSubmit={submitForm}>
                                <div>
                                    <label htmlFor="Name">Kullanıcı Adınız</label>
                                    <div className="relative text-white-dark">
                                        <input id="Name" type="text" placeholder="Kullanıcı adınızı girin"
                                        name='userName' 
                                ...
                                <div>
                                    ...
                                    <div className="relative text-white-dark">
                                        ...
                                        onChange={handleRegformChange}
                                        placeholder="Şifrenizi Girin" className="form-input ps-10 placeholder:text-white-dark" />
                                        <span className="absolute start-4 top-1/2 -translate-y-1/2">
