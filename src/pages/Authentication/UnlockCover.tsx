...
const UnlockCover = () => {
    ...
    useEffect(() => {
        dispatch(setPageTitle('Aktivasyon'));
    });
    ...
    const submitForm =async (e: React.FormEvent<HTMLFormElement>) => {
        e.preventDefault();
        await reActiveMyAccount()
    };

    const {handleLoginformChange, loginForm, reActiveMyAccount}=useAuth()
                        ...
                        <div className="w-full max-w-[440px] lg:mt-16">
                            <div className="mb-10 flex items-center">
                                ...
                                <div className="flex-1">
                                    <h4 className="text-2xl dark:text-white">{auth.currentUser?.displayName}</h4>
                                    <p className="text-white-dark">Hesabınızı tekrar açmak için şifrenizi girin</p>
                                </div>
                            </div>
