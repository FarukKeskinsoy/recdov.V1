...
const Header = () => {
    ...
    const [messages, setMessages] = useState([
        {
            ...
            title: 'Tebrikler!',
            message: 'İşletim sisteminiz güncellendi.',
            time: '1hr',
        },
        {
            id: 2,
            ...
            message: 'Çalışma yüzeyleri arasında geçiş yapabilirsiniz.',
            time: '2hr',
        },
        {
            id: 3,
    ...
    const [notifications, setNotifications] = useState([
        ...
        },
        {
            ...
            message: '<strong className="text-sm mr-1">Adam Nolan</strong> sizden <strong>UX Basics çalışmasında</strong> bahsetti.',
            time: '9h Ago',
        },
        {
            id: 3,
            profile: 'profile-16.jpeg',
            message: '<strong className="text-sm mr-1">Anna Morgan</strong> dosya yükledi.',
            time: '9h Ago',
        },
    ]);
                    ...
                    <div className="sm:flex-1 ltr:sm:ml-0 ltr:ml-auto sm:rtl:mr-0 rtl:mr-auto flex items-center space-x-1.5 lg:space-x-2 rtl:space-x-reverse dark:text-[#d0d2d6]">
                        ...
                        <div className="dropdown shrink-0 flex">
                            <Dropdown
                                ...
                                button={auth.currentUser?.photoURL?<img className="w-9 h-9 rounded-full object-cover saturate-50 group-hover:saturate-100" src="/assets/images/user-profile.jpeg" alt="userProfile" />:
                            ...
                            >
                                ...
                                <div className="ltr:pl-4 rtl:pr-4 truncate">
                                    ...
                                    <li>
                                        <Link to="/profil" className="dark:hover:text-white">
                ...
                <ul className="horizontal-menu hidden py-1.5 font-semibold px-6 lg:space-x-1.5 xl:space-x-8 rtl:space-x-reverse bg-white border-t border-[#ebedf2] dark:border-[#191e3a] dark:bg-black text-black dark:text-white-dark">
                    ...
                    <li className="menu nav-item relative">
                        ...
                        <ul className="sub-menu">
                            ...
                            <li>
                                <NavLink to="https://codead.com.tr" target="_blank">
                                    {t('documentation')}
                                </NavLink>
                            </li>
                        </ul>
